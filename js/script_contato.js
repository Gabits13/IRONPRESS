const translations = {
    'pt': {
      ...
      //pagina contato
      'entre_contato_conosco': 'Entre em contato conosco!',
      'endereco': ' <p id="endereco"><strong>Endereço:</strong> <a  target="_blank" rel="external" href="https://maps.app.goo.gl/gi4SvTq6L3DugVpD7">Rua Edmundo Borck, 64 - Jardim Castelo, SP</a></p>',
      'telefone': ' <p id="telefone"><strong>Telefone:</strong> (11)94753-1301</p>',
      'botao_email': ' <a id="botao-email" href="mailto:ironpressusinagem@gmail.com?subject=Solicitação de Orçamento" class="btn btn-primary">Enviar E-mail</a>',
      'conte_conosco': 'Conte com o nosso serviço de excelência e qualidade!',
      'botao_orcamento': 'Solicitar Orçamento!' 
    ...
    'es': {
     ...
     //footer
      ...
      //pagina contato
      'entre_contato_conosco': '¡Contáctanos!',
      'endereco': ' <p id="endereco"><strong>Dirección:</strong> <a  target="_blank" rel="external" href="https://maps.app.goo.gl/gi4SvTq6L3DugVpD7">Rua Edmundo Borck, 64 - Jardim Castelo, SP</a></p>',
      'telefone': ' <p id="telefone"><strong>Teléfono:</strong> (11)94753-1301</p>',
      'botao_email': ' <a id="botao-email" href="mailto:ironpressusinagem@gmail.com?subject=Solicitação de Orçamento" class="btn btn-primary">Enviar E-mail</a>',
      'conte_conosco': '¡Cuenta con nuestro servicio de excelencia y calidad!!',
      'botao_orcamento': 'Solicitar Presupuesto!' 
    ...
    'en': {
      ...
      //pagina contato
      'entre_contato_conosco': 'Contact Us!',
      'endereco': ' <p id="endereco"><strong>Address:</strong> <a  target="_blank" rel="external" href="https://maps.app.goo.gl/gi4SvTq6L3DugVpD7">Rua Edmundo Borck, 64 - Jardim Castelo, SP</a></p>',
      'telefone': ' <p id="telefone"><strong>Phone Number:</strong> (11)94753-1301</p>',
      'botao_email': ' <a id="botao-email" href="mailto:ironpressusinagem@gmail.com?subject=Solicitação de Orçamento" class="btn btn-primary">Send E-mail</a>',
      'conte_conosco': 'Count on our excellent and quality service!',
      'botao_orcamento': 'Request a Quote!' 
  ...
  function changeLanguage(lang) {
    ...
    //pagina contato
    document.getElementById('entre-contato-conosco').textContent = translations[lang].entre_contato_conosco;
    document.getElementById('endereco').innerHTML = translations[lang].endereco;
    document.getElementById('telefone').innerHTML = translations[lang].telefone;
    document.getElementById('botao-email').innerHTML = translations[lang].botao_email;
    document.getElementById('conte-conosco').textContent = translations[lang].conte_conosco;
    document.getElementById('botao-orcamento').textContent = translations[lang].botao_orcamento;
